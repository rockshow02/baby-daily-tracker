...
const FEATURES=[
  ...
  {key:"quality",icon:"✅",title:"Kualitas Data",description:"Temukan catatan duplikat atau belum lengkap.",tone:"bg-void-raised text-ink-muted"},
  {key:"review",icon:"🤝",title:"Review Bulanan",description:"Tinjau aktivitas dan rencana keluarga per bulan.",tone:"bg-diaper-soft text-diaper"},
];
...
export default function DevelopmentHub({child,onClose}){
 ...
 if(active==="quality")return <DataQualityCenter child={child} onClose={()=>setActive(null)}/>;
 if(active==="review")return <FamilyMonthlyReview child={child} onClose={()=>setActive(null)}/>;
