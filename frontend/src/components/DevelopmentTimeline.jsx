...
export default function DevelopmentTimeline({ child }) {
  ...
  return <section>
    <div className="mb-4 flex items-start justify-between gap-3"><div><h2 className="text-base font-bold text-ink">Linimasa perkembangan</h2>
      ...
      <button onClick={()=>setShowHub(true)} className="shrink-0 rounded-full bg-sleep px-4 py-2.5 text-xs font-bold text-white">Buka Hub</button></div>
    ...
    {showHub && <DevelopmentHub child={child} onClose={()=>setShowHub(false)} />}
  </section>;
}
